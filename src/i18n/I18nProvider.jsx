...
function getInitialLocale(initialLocale) {
  if (initialLocale === 'de' || initialLocale === 'en') return initialLocale
...
export function I18nProvider({ children, initialLocale }) {
  const [locale, setCurrentLocale] = useState(() => getInitialLocale(initialLocale))
